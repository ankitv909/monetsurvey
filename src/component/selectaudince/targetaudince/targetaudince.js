...
class Targetaudince extends Component {
    constructor(props) {
        super(props);
        this.state = {
            date: new Date(),
    ...
    render() {
        ...
        return <div className="targetaudince">
...
Targetaudince.propTypes = {
    classes: PropTypes.object.isRequired,
    theme: PropTypes.object.isRequired,
};

export default withStyles(styles, { withTheme: true })(Targetaudince);
